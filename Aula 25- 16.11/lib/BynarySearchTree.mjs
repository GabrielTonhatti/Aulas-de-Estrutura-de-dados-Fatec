...
// Clase que representa a unidade de informação da árvore binária de busca
class Node {
    constructor(val) {
...
class BinarySearchTree {
    ...
    #insertNode(inserted, root) {
        ...
        // inserção ocorre à ESQUERDA
        if (inserted.data < root.data) {

            // Se a posição à esquerda da raiz está desocupado, faz aí a inserção
