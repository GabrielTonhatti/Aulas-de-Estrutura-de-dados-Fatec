/*
    ...
    a comparação não deve ser feita da função que implementa o algoritmo.
    Em vez disso, recebemos uma outra função (externa) como parâmetro que resolverá a comparação.

    Essa função externa será chamada passando o objeto atual do vetor e esperará um retorno true,
    caso a função externa determine que o objeto atual contém o valor de busca, ou false caso contrário.
*/
...
console.log('Posição de frequency_total 14909: ', buscaSequencial(objNomes, obj => obj.frequency_total === 14909));
