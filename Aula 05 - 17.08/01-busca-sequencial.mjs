...
console.log('Posição de RAFAELA: ', buscaSequencial(nomes, 'RAFAELA'));
console.log('Posição de FELIPE: ', buscaSequencial(nomes, 'FELIPE'));

console.time('Buscando RAFAELA...') // Dispara a contagem de tempo
console.log ('Posição de RAFAELA:', buscaSequencial(nomes, 'RAFAELA'))
console.timeEnd('Buscando RAFAELA...') // Para a contagem de tempo
