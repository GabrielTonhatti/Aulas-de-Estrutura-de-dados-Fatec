...
const densidadeDemografica = (area, populacao) => populacao / area;
...
for (let object of estadosNe) {
   extrairObjeto(object);
}
...
let novoVetor = [];
novoVetor.push(estadosNe[0].nome);
novoVetor.unshift(estadosNe[1].nome);
novoVetor.splice(1, 0, estadosNe[2].nome);
novoVetor.splice(1, 0, estadosNe[3].nome);
novoVetor.splice(2, 0, estadosNe[4].nome);
novoVetor.splice(1, 0, estadosNe[5].nome);
novoVetor.splice(4, 0,estadosNe[6].nome);
novoVetor.splice(2, 0,estadosNe[7].nome);
novoVetor.splice(1, 0,estadosNe[8].nome);
