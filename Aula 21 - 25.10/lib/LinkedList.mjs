...
class Node {
    ...
    constructor(val) {
        ...
        this.next = null;   // Ponteiro para o pŕoximo nodo da sequência
    }
...
export default class LinkedList {
    ...
    insert(pos, val) {
        ...
        // 4º caso: Posição intermediária
            ...
            // Percuso até a posição ANTERIOR à de inserção,
            // saltando de nodo por meio do ponteiro next
            for (let i = 1; i < pos; i++) before = before.next;

            // Nodo da posição POSTERIOR à de inserção
            let after = before.next;

            // O sucessor do nodo inserted passa a ser o nod after
            inserted.next = after;
    ...
    remove(pos) {
        ...
        // 1º caso: a lista está vaiza ou a posição informado está
        ...
        // Decrementa a contagem de nodos da lista
        this.#count--;
...
// Inserção na 1º posição (2º caso)
lista.insert(0, 'Corcel');

// Inserção na posição final (3º caso)
